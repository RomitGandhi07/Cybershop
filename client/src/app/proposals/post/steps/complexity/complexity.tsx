...
import JobPostDescriptionForm from "./job-post-complexity-form";
import { APIStore } from "@/utils/api-store";
import { Notification } from '@/lib/notification/notification';
import { NotificationTypesEnum } from "@/enums/notification-types.enum";

// eslint-disable-next-line react/display-name
const JobComplexity: React.FC<{}> = forwardRef((_, ref) => {
                ...
                <div className="flex justify-between items-start mt-4">
                    ...
                    <div className="w-[50%]">
                        <h1 className="text-3xl font-semibold text-gray-900 leading-tight mb-3">
                            What level of comlpexity of the work?
                        </h1>
                        <p className="text-gray-600 text-sm mb-4 mt-7">This won't restrict any proposals, but helps match expertise to your complexity.</p>
