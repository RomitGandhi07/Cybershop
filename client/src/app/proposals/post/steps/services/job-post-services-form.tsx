...
const JobPostDescriptoinForm: React.FC<IJobPostDescriptionForm> = ({ description, setDescription }) => {
    ...
    const fields = [{
        ...
        type: 'select',
        options: [{label: "Security Policy Development", value: "64d6e38d5f3c7e6b2f9c820c"}],
        label: "Services",
...
export default React.memo(JobPostDescriptoinForm);