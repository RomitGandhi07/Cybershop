...
const JobProposalsCancelled: React.FC = () => {
    const context = useContext(JobProposalsContext);
    const [data, setData] = useState<Array<any>>([]);
    const [loading, setLoading] = useState(true);

    async function fetchJobCancelledProposals() {
        const response = await APIStore.getJobProposals(context.jobId, "Cancelled", {
...
export default JobProposalsCancelled;