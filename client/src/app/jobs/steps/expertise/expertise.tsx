...
import JobPostDescriptionForm from "./job-expertise-duration-form";
import { APIStore } from "@/utils/api-store";
import { Notification } from '@/lib/notification/notification';
import { NotificationTypesEnum } from "@/enums/notification-types.enum";

// eslint-disable-next-line react/display-name
const JobExpertise: React.FC<{}> = forwardRef((_, ref) => {
            ...
            <div className="p-8 bg-white flex flex-col justify-between">
                ...
                <div className="flex justify-between items-start mt-4">
                    ...
                    <div className="w-[50%]">
                        ...
                        <p className="text-gray-600 text-sm mb-4 mt-7">This won't restrict any proposals, but helps match expertise to your budget.</p>
