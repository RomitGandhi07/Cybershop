...
const Stepper: React.FC<StepperProps> = ({
    ...
    return (
        <div className="flex flex-col items-center justify-center">
            ...
            {/* Step Component */}
            <div className="p-4 border rounded-2xl w-full max-w-6xl h-[80%]">
                {
                    displayHeaderTitle &&
            ...
            {/* Navigation Buttons */}
            <div className="w-full p-4 bg-white shadow-md flex justify-center items-center fixed bottom-0">
                ...
                <BorderButton
                    isLoader={false}
                    onClick={prevStep}
                    className="px-4 py-2 block w-24 text-center text-orange-600 border border-orange-600 rounded-3xl p-3 text-sm font-medium hover:bg-orange-50 transition duration-200"
                // mergeClasses={true}
                >
                    Previous
                </BorderButton>
